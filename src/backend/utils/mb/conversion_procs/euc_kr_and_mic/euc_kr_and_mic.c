 ...
 *
 * IDENTIFICATION
 *	  $Header: /home/rubik/work/pgcvs/CVSROOT/pgsql/src/backend/utils/mb/conversion_procs/euc_kr_and_mic/euc_kr_and_mic.c,v 1.6.4.2 2009-01-29 19:25:13 tgl Exp $
 *
 *-------------------------------------------------------------------------
 */
