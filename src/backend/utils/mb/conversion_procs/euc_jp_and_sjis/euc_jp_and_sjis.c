 ...
 *
 * IDENTIFICATION
 *	  $Header: /home/rubik/work/pgcvs/CVSROOT/pgsql/src/backend/utils/mb/conversion_procs/euc_jp_and_sjis/euc_jp_and_sjis.c,v 1.6.4.1 2005-06-11 02:50:07 ishii Exp $
 *
 *-------------------------------------------------------------------------
 */
